...
const NullErrorModal = (props: Props) => {
    ...
    <>
      <div
        ...
        <div className={'flex flex-col gap-y-1 bg-white rounded-[32px] p-5'}>
          <div className={'text-h2 font-semibold text-black'}>자격증을 한개 이상 선택해주세요!</div>
          <div>
            <div className={'flex items-center text-h6 gap-x-1'}>
              한개 이상의 자격증을 선택하면 <LogoIcon /> 이
            </div>
          </div>
