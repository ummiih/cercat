...
interface Props {
  setIsGoalSettingStatusModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
  isGoalSettingStatusModalOpen: boolean;
}

const GoalSettingStatusModal = (props: Props) => {
  const { setIsGoalSettingStatusModalOpen, isGoalSettingStatusModalOpen } = props;
        ...
        <div className={'flex flex-col gap-y-4 bg-white rounded-[32px] p-5'}>
          <div className={'flex flex-col gap-y-1'}>
            ...
            <div className={'flex flex-col gap-y-1'}>
              ...
              <div className={'text-h6'}>자격증 취득까지의 학습관리를 도와드려요!</div>
            </div>
          </div>
...
export default GoalSettingStatusModal;
...
const ArrowIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" {...props}>
    <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" d="m5 11 6-6M5 5h6v6" />
  </svg>
);
